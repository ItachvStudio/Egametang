...
public class BMFontEditor : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        if (GUILayout.Button("Create BMFont"))
        {
            ...
            fontPath = Application.dataPath + "/Res/Font";
            Debug.Log($"----{this.fontPath}");
            AssetDatabase.ImportAsset(this.fontPath, ImportAssetOptions.ForceSynchronousImport | ImportAssetOptions.ForceUpdate);
            Close();
        }
    }
